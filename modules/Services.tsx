    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="bg-amber-600 hover:bg-amber-500 text-white px-6 py-2 rounded-xl text-sm font-bold transition-all flex items-center gap-2"
        >
          ...
          <tbody className="divide-y divide-white/5">
            {services.map(svc => (
              <tr key={svc.id} className="hover:bg-white/5 transition-colors group">
                ...
                <td className="px-6 py-4 text-right font-bold text-amber-500">${svc.price}</td>
